  ...
  return (
    ...
    <div className="cart-item-detail">
      ...
      <div className='cart-item-details3'>
        <div style={{fontSize:'80%',color:'gray',textDecoration:'line-through'}}>₹{cartitem.originalPrice}</div>
        <div  style={{fontSize:'110%',fontWeight:'bold'}}>₹{cartitem.sellingPrice}</div>
        <div style={{fontSize:'90%',color:'green'}}>({cartitem.discount}%OFF)</div>
      </div>
