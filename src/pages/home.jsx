...
export default function Home() {
  ...
  const fetchwithauth = async () => {
    let sessionKey = localStorage.getItem('sessionId');
    const response = await fetch(
      'http://ec2-13-203-205-26.ap-south-1.compute.amazonaws.com:8081/user/api/validate',
      {
        method: 'POST',
        credentials: 'include',
        headers: {
  ...
  useEffect(() => {
    ...
    fetch(
      `http://ec2-13-203-205-26.ap-south-1.compute.amazonaws.com:8081/product/`,
      {
        method: 'GET',
        credentials: 'include',
        headers: {
      ...
      .then((finalProducts) => {
        console.log(
          'Final Products with Ratings and Categories:',
          finalProducts,
        );
  ...
  const getTopProducts = () => {
    const products = product
      .filter((item) => item?.rating?.score > 4.8)
      .reverse();
  ...
  return (
    <div className="whole-box">
      <div className="box1">
        ...
        >
          <SwiperSlide className="box1-img-cont">
            <img
              src="https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8c2hvcHBpbmd8ZW58MHx8MHx8fDA%3D"
              className="box1-img"
            />
            <img
              src="https://images.unsplash.com/photo-1607082350899-7e105aa886ae?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="box2-img"
            />
            <img
          ...
          <SwiperSlide className="box1-img-cont">
            ...
            />
            <img
              src="https://images.unsplash.com/photo-1517527102881-ebec4986ab1b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="box2-img"
            />
            <img
              src="https://images.unsplash.com/photo-1527264935190-1401c51b5bbc?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <SwiperSlide className="box1-img-cont">
            <img
              src="https://images.unsplash.com/photo-1651173859954-76c635fb2a0e?q=80&w=2044&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="box1-img"
            />
            <img
              src="https://images.unsplash.com/photo-1546502208-81d149d52bd7?q=80&w=2073&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="box2-img"
            />
            <img
              src="https://images.unsplash.com/photo-1651173859954-76c635fb2a0e?q=80&w=2044&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      ...
      <div className="box2">
        <div className="box21">Shop by Category</div>
        <div className="box22">
          <button
            onClick={() => scrollLeft(scrollRef1)}
            className="scroll-btnn left"
          >
            &#8249;
          </button>
                ...
                <div className="top-products-cont">
                  ...
                  <div className="top-pro-det">
                    ...
                    <div className="top-pro-det2">
                      ...
                      <div style={{ lineHeight: '150%', marginLeft: '3%' }}>
                        {' '}
                        ({item?.rating?.score})
                      </div>
                    </div>
